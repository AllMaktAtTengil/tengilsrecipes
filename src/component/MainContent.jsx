                                      ...
                                      <div key={index}>
                                          <div className={`rand-recipes`}>
                                              <Link to={`/recipe-information/${recipes.id}`}>
                                                  <h1>{recipes.title}</h1>
                                                  {recipes.image === undefined ? <img src="https://www.corepixel.se/pub_images/original/No-image-available.jpg" alt="example" style={{ width: "230px", height: "230px" }} /> : <img src={recipes.image} alt="example" />}
                                              </Link>
