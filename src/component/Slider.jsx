                                  ...
                                  <div key={index}>
                                      <div className="rand-recipes" id={`recipe-box-${index}`}>
                                          <Link to={`/recipe-information/${recipe.id}`}>
                                              <h1>{recipe.title}</h1>
                                              {recipe.image === undefined ? <img src="https://www.corepixel.se/pub_images/original/No-image-available.jpg" alt="example" style={{ width: "230px", height: "230px" }} /> : <img src={recipe.image} alt="example" />}
                                          </Link>
